...
function calculateFaceMove(e) {
  ...
  if (email.scrollWidth <= emailScrollMax) {
    ...
    eyeLX = Math.cos(eyeLAngle) * eyeMaxHorizD;
    eyeLY = Math.sin(eyeLAngle) * eyeMaxVertD;
    eyeRAngle = getAngle(
      eyeRCoords.x,
      eyeRCoords.y,
      emailCoords.x + caretCoords.x,
    ...
    eyeRX = Math.cos(eyeRAngle) * eyeMaxHorizD;
    eyeRY = Math.sin(eyeRAngle) * eyeMaxVertD;
    noseAngle = getAngle(
      noseCoords.x,
      noseCoords.y,
      emailCoords.x + caretCoords.x,
    ...
    noseX = Math.cos(noseAngle) * noseMaxHorizD;
    noseY = Math.sin(noseAngle) * noseMaxVertD;
    mouthAngle = getAngle(
      mouthCoords.x,
      mouthCoords.y,
      emailCoords.x + caretCoords.x,
    ...
    mouthX = Math.cos(mouthAngle) * noseMaxHorizD;
    mouthY = Math.sin(mouthAngle) * noseMaxVertD;
    ...
    emailIsScrolling = false;
  } else {
    if (!emailIsScrolling) {
      emailIsScrolling = true;
    }
  }
